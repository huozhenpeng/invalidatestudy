...
public class InvalidateView2 extends View {
    public InvalidateView2(Context context) {
        this(context,null);
    }

    public InvalidateView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,-1);
    }

    public InvalidateView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
